...
$config = array(
  ...
  'simpleexample' => array(
    ...
    'saml:SP',
        ...
        //                                          // Can be NULL/unset, in which case a builtin discovery service will be used.
          ...
          'attributes'=> array('FrEduVecteur'),
            'name' => array(
                                  'en-us' => 'ENT Attribute Set',
                                 ),
  ...
  'Agentportal' => array(
                       'saml:SP',
                        ...
                        // The entity ID of this SP.
                       //    // Can be NULL/unset, in which case an entity ID is generated based on the metadata URL.
                      'entityID' => 'AgentPortal',
                      'certificate' => 'saml.crt',
                      'privatekey'  => 'saml.pem',
                       //
                       //                          // The entity ID of the IdP this should SP should contact.
                       //                              // Can be NULL/unset, in which case the user will be shown a list of available IdPs.
                      'idp' => 'urn:fi:ac-lyon:AA:1.0',
                       //
                       //                                      // The URL to the discovery service.
                       //                                          // Can be NULL/unset, in which case a builtin discovery service will be used.
                       'discoURL' => NULL,
...
/*
  'aten' => array (
    'saml:SP',
    'entityID' => 'https://viesco.ac-lyon.fr/sso/SSO',
    'pritavekey' => 'saml.pem',
    'certificate' => 'saml.crt',
    'redirect.sign' => TRUE,
  ...
  'rnb' => array (
    'saml:SP',
    'entityID' => 'https://services.ac-lyon.fr/sso/SSO',
    'privatekey' => 'saml.pem',
    'certificate' => 'saml.crt',
    'redirect.sign' => TRUE,
    'redirect.validate' => TRUE,
